...
class GameCard:
    ...
    def downloadSave(self):
        ...
        with open('progress.txt', 'a+') as f:
            subprocess.Popen(args=['/home/lois/ble-new/005tools', 'download', 'savefile.sav', '--save-size=524288'], stdout=f, stderr=f, universal_newlines=True)
            # while True:
            #     line = str(proc.stdout.read(100))
            #     if not line:
            #         break
    ...
    def uploadSave(self):        
        ...
        with open('progress.txt', 'a+') as f:
            subprocess.Popen(args=['/home/lois/ble-new/005tools', 'upload', 'savefile.sav', '--save-size=524288'], stdout=f, stderr=f, universal_newlines=True)
            # while True:
            #     line = str(proc.stdout.read(100))
            #     if not line:
            #         break
    ...
    def read(self):
        ...
        res = asyncio.run(self.readInfo('/home/lois/ble-new/005tools info'))
